...
// implemented.
//
// Decide to go with a 'simple' UIView - as is supposed to be able to recive and process events. And scrolling should have been able to be simulated at least - or so i thought. If  had more time I would give implementing a UISCrollview a shot.
...
// So I am dissappointed its not finished; I gave it a good shot!
...
-(NSString *)timeFromISO860String
{
    ...
    NSString *timeStamp =[self ISO8601TimeAndDateString];
    NSArray *ISOcomponents  = [timeStamp componentsSeparatedByCharactersInSet:
